...
\draw[anchor=north] (midpoint) node [fill=orange,fill opacity=0.2,text opacity=1,inner sep=1cm]{\Huge\centering\sffamily\parbox[c][][t]{\paperwidth}{\bf \centering \zihao{-0}  广义相对论入门\\[1pt] % Book title
...
\chapterimage{ruru.png}
\input{./Chaps/Chap3}

%\chapterimage{hatsuyuki01.png}
\input{./Chaps/Chap4}

%\chapterimage{tsukimime.png}
\input{./Chaps/Chap5}

%\chapterimage{akira.png}
\input{./Chaps/Chap6}

%\chapterimage{kurisu.png}
\input{./Chaps/Chap7}
