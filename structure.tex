...
{\addvspace{15pt}\sffamily\bf} % Spacing and font options for chapters
...
\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=2pt,rounded corners=15pt,draw=white,fill=white,fill opacity=0.8,inner sep=15pt]{\strut\makebox[22cm]{}};
